    ...
    public partial class Inicial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Incidencias", x => x.Codigo);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServiciosCalendario", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServiciosAuxiliares", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                table: "Incidencias",
                columns: new[] { "Codigo", "Notas", "TextoIncidencia", "Tipo" },
